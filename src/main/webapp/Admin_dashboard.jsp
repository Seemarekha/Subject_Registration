...
%>
    ...
    <div class="hero">
        <nav>
            ...
            <img src="C:\Users\alokk\Pictures\Alok\1686988790700.jpg" class="user-pic" onclick="toggleMenu()">
            <div class="sub-menu-wrap" id="subMenu">
                <div class="sub-menu">
                    <div class="user-info">
                        <img src=C:\Users\alokk\Pictures\Alok\1686988790700.jpg>
                    ...
                    <a href="admin_regi.html" class="sub-menu-link">
            ...
            <div class="card-wrapper swiper-wrapper">
                <div class="card swiper-slide">
                    ...
                    <div class="card-content">
                        ...
                        <a href="Registered_student_list.jsp" class="button">Click</a>
                    </div>
                </div>
                <div class="card swiper-slide">
                    <div class="image-content">
